...
#define EVSE_STATE_A_LOWER_THRESHOULD (3710)

#define EVSE_STATE_B_UPPER_THRESHOULD (3709)

#define EVSE_STATE_B_LOWER_THRESHOULD (3400) // previous 2800

#define EVSE_STATE_C_UPPER_THRESHOULD (1750)
...
#define EVSE_STATE_SUS_UPPER_THRESHOULD (1950)

#define EVSE_STATE_SUS_LOWER_THRESHOULD (1770)
