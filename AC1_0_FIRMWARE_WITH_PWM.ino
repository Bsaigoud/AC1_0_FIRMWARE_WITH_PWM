...
#if RELAY_DROP
	ptr_evse_relay->evse_relay1_pwm_init();
	ptr_evse_relay->evse_relay2_pwm_init();
	ptr_evse_relay->evse_relay3_pwm_init();
if (relay_dropflag == 1)
		{
			ptr_evse_relay->evse_relay1_pwm_0();
			ptr_evse_relay->evse_relay2_pwm_0();
			ptr_evse_relay->evse_relay3_pwm_0();
		}
...
ptr_evse_relay->evse_relay_off();
		...
		// Serial.print("GFCI TEST: ");
		// Serial.println(lu8_gfci);
		...
		// Serial.print("EARTH_PRESENCE_PIN  test: ");
		// Serial.println(lu32_earth_disconnect);
...
void ControlPilot(void* p)
{
	...
	while (1)
	{
		...
		if ((relay_dropflag == 1) && (timer <= 750))
		{
			...
			// {
			// 	relay_duty = 75;
			// 	ptr_evse_relay->evse_relay1_pwm_75();
			// 	ptr_evse_relay->evse_relay2_pwm_75();
			// 	ptr_evse_relay->evse_relay3_pwm_75();
			// }
			...
			{
				relay_duty = 50;
				ptr_evse_relay->evse_relay1_pwm_50();
				ptr_evse_relay->evse_relay2_pwm_50();
				ptr_evse_relay->evse_relay3_pwm_50();
			}
			...
			(gs32EVSE_SMW_Control_pilot_Average > evse_state_c_lower_threshold))
		{
			...
			if ((evse_ChargePointStatus != Faulted)) //&& (EVSE_transaction_status == EVSE_START_TRANSACTION))
			{
				...
				if (relay_duty == 100)
				{
					ptr_evse_relay->evse_relay1_pwm_100();
					ptr_evse_relay->evse_relay2_pwm_100();
					ptr_evse_relay->evse_relay3_pwm_100();
				}
#else
